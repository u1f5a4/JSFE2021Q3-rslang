...
router.add('audioCall/0', () => audioCallGame.displayPage());
router.add('audioCall/1', () => audioCallGame.displayPage());
router.add('audioCall/2', () => audioCallGame.displayPage());
router.add('audioCall/3', () => audioCallGame.displayPage());
router.add('audioCall/4', () => audioCallGame.displayPage());
router.add('audioCall/5', () => audioCallGame.displayPage());
